...
-- \   \   \/     Version: P.20131013
--  \   \         Application: netgen
--  /   /         Filename: adderN_timesim.vhd
-- /___/   /\     Timestamp: Fri Apr 23 10:13:26 2021
-- \   \  /  \ 
--  \___\/\___\
--             
-- Command	: -intstyle ise -s 10 -pcf adderN.pcf -rpw 100 -tpw 0 -ar Structure -tm adderN -insert_pp_buffers true -w -dir netgen/par -ofmt vhdl -sim adderN.ncd adderN_timesim.vhd 
-- Device	: 4vsx35ff668-10 (PRODUCTION 1.71 2013-10-13)
-- Input file	: adderN.ncd
-- Output file	: D:\Document FPGA\ThayThuy\FPGA\Virtex_4_ML402\project_ISE_adderN\netgen\par\adderN_timesim.vhd
-- # of Entities	: 1
-- Design Name	: adderN
...
architecture Structure of adderN is
  ...
  signal NlwBufferSignal_Sum_1_OBUF_I : STD_LOGIC; 
  signal NlwBufferSignal_Sum_3_OBUF_I : STD_LOGIC; 
  signal NlwBufferSignal_Sum_2_OBUF_I : STD_LOGIC; 
  signal NlwBufferSignal_Sum_0_OBUF_I : STD_LOGIC; 
...
begin
  ...
  Sum_1_OBUF : X_OBUF
    ...
    port map (
      I => NlwBufferSignal_Sum_1_OBUF_I,
      O => Sum(1)
    );
  ...
  Sum_3_OBUF : X_OBUF
    ...
    port map (
      I => NlwBufferSignal_Sum_3_OBUF_I,
      O => Sum(3)
    );
  Sum_2_OBUF : X_OBUF
    generic map(
    ...
    port map (
      I => NlwBufferSignal_Sum_2_OBUF_I,
      O => Sum(2)
    );
  Cin_IBUF : X_BUF
    generic map(
  ...
  Sum_0_OBUF : X_OBUF
    ...
    port map (
      I => NlwBufferSignal_Sum_0_OBUF_I,
      O => Sum(0)
    );
  ...
  NlwBufferBlock_Sum_1_OBUF_I : X_BUF
    generic map(
      PATHPULSE => 441 ps
    )
    port map (
      I => Sum_1_OBUF_118,
      O => NlwBufferSignal_Sum_1_OBUF_I
    );
  NlwBufferBlock_Sum_3_OBUF_I : X_BUF
    generic map(
      PATHPULSE => 441 ps
    )
    port map (
      I => Sum_3_OBUF_125,
      O => NlwBufferSignal_Sum_3_OBUF_I
    );
  NlwBufferBlock_Sum_2_OBUF_I : X_BUF
    generic map(
      PATHPULSE => 441 ps
    )
    port map (
      I => Sum_2_OBUF_126,
      O => NlwBufferSignal_Sum_2_OBUF_I
    );
  NlwBufferBlock_Sum_0_OBUF_I : X_BUF
    generic map(
      PATHPULSE => 441 ps
    )
    port map (
      I => Sum_0_OBUF_119,
      O => NlwBufferSignal_Sum_0_OBUF_I
    );
